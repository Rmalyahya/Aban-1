/*
*  view_my_profile2_faculty_member_widget.dart
*  UI
*
*  Created by [Author].
...
class ViewMyProfile2FacultyMemberWidget extends StatelessWidget {
            ...
            Positioned(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    height: 95,
                    margin: EdgeInsets.only(left: 39, top: 7, right: 17),
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.stretch,
                      children: [
                        Align(
                  ...
                  Align(
                    ...
                    child: Container(
                      width: 160,
                      height: 20,
                      margin: EdgeInsets.only(top: 23, right: 17),
                      child: Row(
                  ...
                  Align(
                    alignment: Alignment.topRight,
                    child: Container(
                      margin: EdgeInsets.only(top: 3, right: 41),
                      child: Text(
                        "الذهاب إلى أبحاثي",
                        textAlign: TextAlign.right,
                        style: TextStyle(
                  ...
                  Container(
                    height: 50,
                    margin: EdgeInsets.only(left: 2, top: 41),
                    child: Stack(
                      alignment: Alignment.center,
                      children: [
                        Positioned(
                  ...
                  Align(
                    alignment: Alignment.topRight,
                    child: Container(
                      margin: EdgeInsets.only(top: 23, right: 41),
                      child: Text(
                        ".أطروحات مكتملة تحت إشرافي",
                        textAlign: TextAlign.right,
                        style: TextStyle(
                          color: AppColors.secondaryText,
                          fontFamily: "Neo Sans W23",
