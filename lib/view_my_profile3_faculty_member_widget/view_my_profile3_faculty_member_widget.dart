/*
*  view_my_profile3_faculty_member_widget.dart
*  UI
*
*  Created by [Author].
...
class ViewMyProfile3FacultyMemberWidget extends StatelessWidget {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Align(
                    alignment: Alignment.topRight,
                    child: Container(
                      margin: EdgeInsets.only(top: 23, right: 40),
                      child: Text(
                        ".أطروحات جارية تحت إشرافي",
                        textAlign: TextAlign.right,
                        style: TextStyle(
                          color: AppColors.secondaryText,
                          fontFamily: "Neo Sans W23",
