...
class GuestHomeMenuWidget extends StatelessWidget {
                  ...
                  Positioned(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          height: 108,
                          margin: EdgeInsets.only(left: 22, top: 31, right: 59),
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.stretch,
                            children: [
                              Align(
                        ...
                        Container(
                          height: 108,
                          margin: EdgeInsets.only(left: 22, top: 12, right: 59),
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.stretch,
                            children: [
                              Align(
                        ...
                        Container(
                          height: 108,
                          margin: EdgeInsets.only(left: 22, right: 59, bottom: 12),
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.stretch,
                            children: [
                              Align(
                        ...
                        Container(
                          height: 108,
                          margin: EdgeInsets.only(left: 22, right: 59, bottom: 27),
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.stretch,
                            children: [
                              Align(
                        ...
                        Container(
                          height: 15,
                          margin: EdgeInsets.only(right: 45, bottom: 17),
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.stretch,
                            children: [
                              Align(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Align(
                          alignment: Alignment.topRight,
                          child: Container(
                            margin: EdgeInsets.only(top: 2, right: 24),
                            child: Text(
                              "تسجيل جديد",
                              textAlign: TextAlign.right,
                              style: TextStyle(
