/*
*  view_graduate_student_profile_widget.dart
*  UI
*
*  Created by [Author].
...
class ViewGraduateStudentProfileWidget extends StatelessWidget {
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Container(
                      width: 66,
                      height: 24,
                      margin: EdgeInsets.only(left: 26, top: 38),
                      child: Row(
                        children: [
                          Align(
                            alignment: Alignment.topLeft,
                  ...
                  Container(
                    height: 95,
                    margin: EdgeInsets.only(left: 39, top: 5, right: 16),
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.stretch,
                      children: [
                        Align(
                  ...
                  Align(
                    alignment: Alignment.topRight,
                    child: Container(
                      margin: EdgeInsets.only(top: 26, right: 40),
                      child: Text(
                        "الذهاب إلى أبحاثي",
                        textAlign: TextAlign.right,
                        style: TextStyle(
