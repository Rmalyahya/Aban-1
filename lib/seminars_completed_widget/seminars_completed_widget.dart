/*
*  seminars_completed_widget.dart
*  UI
*
*  Created by [Author].
...
class SeminarsCompletedWidget extends StatelessWidget {
                                    ...
                                    child: Stack(
                                      ...
                                      children: [
                                        Positioned(
                                          ...
                                          right: 0,
                                          child: Image.asset(
                                            "assets/images/combined-shape-8.png",
                                            fit: BoxFit.cover,
                                          ),
                                        ),
                                        Positioned(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  width: 55,
                                                  height: 43,
                                                  margin: EdgeInsets.only(top: 19, right: 14),
                                                  child: Column(
                                                    crossAxisAlignment: CrossAxisAlignment.stretch,
                                                    children: [
                                                      Align(
                              ...
                              children: [
                                Align(
                                  ...
                                  child: Container(
                                    ...
                                    height: 53,
                                    child: Image.asset(
                                      "assets/images/combined-shape-10.png",
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
